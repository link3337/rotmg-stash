...
export const classes: Classes = {
  ...
  [ClassID.Archer]: [
    ...
    [750, 300, 75, 25, 55, 50, 40, 50],
    [3, 15, 6, 9]
  ],
  [ClassID.Wizard]: [
    ClassName.Wizard,
    [100, 150, 17, 0, 17, 17, 5, 23],
    [575, 290, 55, 9.5, 36, 55, 24, 42],
    [700, 400, 75, 25, 50, 75, 40, 60],
    [17, 11, 14, 9]
  ],
  [ClassID.Priest]: [
    ClassName.Priest,
    [100, 150, 26, 0, 22, 23, 5, 17],
    [575, 290, 35, 9.5, 41, 42, 24, 55],
    [700, 400, 65, 25, 55, 60, 40, 75],
    [8, 4, 14, 9]
  ],
  [ClassID.Samurai]: [
    ClassName.Samurai,
    ...
    [800, 300, 75, 30, 55, 55, 60, 60],
    [24, 27, 7, 9]
  ],
  [ClassID.Bard]: [
    ClassName.Bard,
    [150, 150, 20, 0, 22, 12, 10, 17],
    [625, 290, 39, 9.5, 41, 50, 29, 55],
    [750, 400, 55, 25, 55, 70, 45, 75],
    [3, 28, 14, 9]
  ],
  [ClassID.Warrior]: [
    ClassName.Warrior,
  ...
  [ClassID.Paladin]: [
    ...
    [800, 300, 55, 30, 55, 55, 60, 75],
    [1, 12, 7, 9]
  ],
  [ClassID.Assassin]: [
    ClassName.Assassin,
    [150, 125, 26, 0, 26, 17, 5, 23],
    [625, 214, 45, 9.5, 45, 55, 24, 42],
    [750, 350, 65, 25, 65, 75, 40, 60],
    [2, 18, 6, 9]
  ],
  [ClassID.Necromancer]: [
    ClassName.Necromancer,
    [100, 150, 17, 0, 17, 23, 5, 17],
    [575, 290, 55, 9.5, 36, 42, 24, 55],
    [700, 400, 75, 25, 50, 60, 40, 75],
    [17, 19, 14, 9]
  ],
  [ClassID.Huntress]: [
    ClassName.Huntress,
    [150, 125, 26, 0, 17, 23, 5, 23],
    [625, 214, 45, 9.5, 36, 42, 24, 42],
    [750, 350, 65, 25, 50, 60, 40, 60],
    [3, 20, 6, 9]
  ],
  [ClassID.Mystic]: [
    ClassName.Mystic,
    [100, 150, 26, 0, 27, 26, 5, 17],
    [575, 290, 45, 9.5, 46, 45, 24, 55],
    [700, 400, 65, 25, 60, 65, 40, 75],
    [17, 21, 14, 9]
  ],
  [ClassID.Trickster]: [
    ClassName.Trickster,
  ...
  [ClassID.Sorcerer]: [
    ...
    [700, 400, 70, 25, 60, 60, 75, 60],
    [8, 23, 14, 9]
  ],
  [ClassID.Ninja]: [
    ClassName.Ninja,
    [200, 150, 12, 0, 27, 12, 23, 12],
    [675, 195, 50, 9.5, 46, 50, 42, 50],
    [800, 300, 70, 25, 60, 70, 60, 70],
    [24, 25, 6, 9]
  ],
  [ClassID.Summoner]: [
    ClassName.Summoner,
    [100, 150, 23, 0, 27, 17, 5, 17],
    [575, 290, 42, 9.5, 46, 55, 24, 55],
    [700, 400, 60, 25, 60, 75, 40, 75],
    [8, 29, 14, 9]
  ],
  [ClassID.Kensei]: [
    ClassName.Kensei,
...
export const exaltStats: string[] = ['DEX', 'SPD', 'VIT', 'WIS', 'DEF', 'ATT', 'MP', 'HP'];
