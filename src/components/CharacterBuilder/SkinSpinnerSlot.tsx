...
const SkinSpinnerSlot: React.FC<SkinSpinnerSlotProps> = ({
    skinPool,
    previewPool,
    selectedSkinId,
    strip,
    ...
    const selectedName = selectedSkinId > 0 ? (skinNameById[selectedSkinId] ?? `Skin #${selectedSkinId}`) : '';
        ...
        <div className={styles.slotCard}>
            <div className={styles.slotHeader}>
                <Button
                    ...
                    text
                    icon="pi pi-refresh"
                    label={isRolling ? 'Spinning...' : 'Reroll Skin'}
