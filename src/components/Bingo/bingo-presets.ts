...
export const BINGO_PRESETS: BingoPreset[] = [
  {
    ...
    goals: [
      ...
      { id: 'adv-03', label: 'Reach 2000 fame on one character', difficulty: 'easy' },
      ...
      { id: 'adv-21', label: 'Reach 6/8 stats on one character', difficulty: 'hard', characterMode: 'existing' },
      ...
      { id: 'adv-31', label: 'Solo Void', difficulty: 'goat', characterMode: 'existing' },
      { id: 'adv-32', label: 'Solo Shatters', difficulty: 'goat', characterMode: 'existing' },
  ...
  },
  {
    ...
    goals: [
      ...
      { id: 'loot-11', label: 'Get 5 dungeon marks of different types', difficulty: 'easy', characterMode: 'new' },
      ...
      { id: 'loot-19', label: 'Get 1 exaltation dungeon white bag', difficulty: 'hard', characterMode: 'existing' },
      { id: 'loot-21', label: 'Collect 12 potions total', difficulty: 'easy', characterMode: 'new' },
      ...
      { id: 'loot-23', label: 'Loot 4 dungeon keys from events/chests', difficulty: 'hard', characterMode: 'existing' },
  ...
  },
  {
    ...
    goals: [
      ...
      { id: 'boss-17', label: 'Defeat Oryx the Mad God 3', difficulty: 'hard', characterMode: 'existing' },
      ...
      { id: 'boss-23', label: 'Defeat Shatters final boss', difficulty: 'hard', characterMode: 'existing' },
      ...
      { id: 'boss-26', label: 'Defeat 2 exalt dungeon bosses', difficulty: 'hard', characterMode: 'existing' },
